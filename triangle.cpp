...
EXPECT_EQ(4,triangle(201,5,5));
EXPECT_EQ(4,triangle(5,201,5));
EXPECT_EQ(4,triangle(5,5,201));
EXPECT_EQ(4,triangle(-1,5,5));
EXPECT_EQ(4,triangle(5,-1,5));
EXPECT_EQ(4,triangle(5,5,-1));
EXPECT_EQ(4,triangle(-1,-1,5));
EXPECT_EQ(4,triangle(5,-1,-1));
EXPECT_EQ(4,triangle(-1,5,-1));
EXPECT_EQ(4,triangle(-1,-1,-1));
}
